...
const MenuPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col ">
            {/* Header */}
            <header className="flex items-center justify-between bg-red-700 p-4 h-16">
            ...
            <main className="flex flex-1">
                ...
                {/* Right Column (Orders) */}
                <div
                    className="w-80 border-l px-4 py-6 bg-white flex flex-col"
                ...
                >
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-blue-600 text-white rounded-md text-lg font-semibold hover:bg-blue-700"
                    >
                        Confirm
                    </button>
                </div>
